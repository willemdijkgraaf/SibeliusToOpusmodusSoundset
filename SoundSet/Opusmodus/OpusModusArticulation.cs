...
namespace SoundSet.Opusmodus
{
    ...
    {
        private readonly SwitchType _switch;
        private readonly SibeliusSoundSetType _sibeliusSoundSet;
        private readonly Dictionary<sbyte, string> _keys = new Dictionary<sbyte, string>()
        {
            { 0, "c"},
            { 1, "cs"},
            { 2, "d"},
        ...
        private readonly Dictionary<string, string> _SibeliusToOpusmodusArticulation = new Dictionary<string, string>()
        {
            { "staccato" ,"stacc"},
            { "staccatissimo" ,"stacs"},
            { "detache" ,"deta"},
        ...
        public string Omn()
        {
            ...
            if (!_SibeliusToOpusmodusArticulation.ContainsKey(keyName)) return null;
